    ...
    <SafeAreaProvider>
      ...
      >
        <View style={styles.container}>
          {/* Status Bar */}
          <Stack.Screen options={{ title: t('rooms.screenTitle') }} />
          ...
          <View style={styles.roomsHistoryContainer}>
            ...
            <TouchableOpacity style={[styles.roomsHistoryButton, { opacity: 0 }]}>
              <Text style={styles.roomsHistoryText}>{t('rooms.roomsHistory')}</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.profileSection}>
            <View style={styles.profileInfo}>
              ...
              <View style={{ justifyContent: 'center', alignItems: 'center', gap: 5, width: '50%' }}>
                ...
                <VioletButton title={t('common.change')} onPress={() => setChangeUserModalVisible(true)} />
              </View>
            </View>
