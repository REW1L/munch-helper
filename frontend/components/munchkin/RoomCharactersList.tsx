    ...
    if (isLoading) {
      return (
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>{t('room.loadingCharacters')}</Text>
        </View>
      );
    }
    ...
    <FlatList
      ...
      ListFooterComponent={
        <View style={styles.createCharacterButtonContainer}>
          <VioletButton title={t('room.createCharacter')} onPress={onCreateCharacter} disabled={isCreateBlocked} testID="create-character-button" />
        </View>
      }
