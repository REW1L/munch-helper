...
- [x] 1.3 Clip captured screenshots to each bezel's rounded screen opening so screenshot corners cannot protrude past the device border.
...
- [x] 3.4 Regenerate captioned previews and visually inspect iPhone and Android corners for clipped screen content inside the bezels.
